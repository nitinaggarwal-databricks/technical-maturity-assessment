...
class IntelligentRecommendationEngine {
  ...
  mapPainPointsToFeatures(painPoints, pillarId) {
    ...
    const featureMap = {
      ...
      'data_misuse': ['SQL Warehouses', 'Query History', 'Row-Level Security', 'Partner Connect'],
      'regulatory_exposure': ['Databricks SQL', 'Partner Connect', 'Power BI Connector', 'Tableau Integration'],
      'compliance_sharing': ['Databricks SQL', 'Partner Connect', 'Power BI Connector', 'Google Sheets Connector'],
      'external_sharing': ['Databricks SQL', 'Partner Connect', 'Power BI Connector', 'Tableau Integration'],
      'data_monetization': ['Databricks SQL', 'Dashboards', 'Partner Connect', 'SQL Warehouses'],
      'partner_collaboration': ['Partner Connect', 'Power BI Connector', 'Tableau Integration', 'Google Sheets Connector'],
