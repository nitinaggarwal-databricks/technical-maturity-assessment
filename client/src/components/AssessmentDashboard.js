...
const AssessmentDashboard = ({ currentAssessment, framework, onLogout }) => {
  ...
  if (!currentAssessment) {
    return (
      <DashboardContainer>
        <ContentWrapper>
          <WelcomeSection>
            <WelcomeTitle>No Active Assessment</WelcomeTitle>
            <WelcomeSubtitle>You don't have an active assessment. Start a new one to continue.</WelcomeSubtitle>
            <ActionButton
              variant="primary"
