...
router.post('/message', async (req, res) => {
  try {
    ...
    const aiResponse = await generateSmartAIResponse(
      message, 
...
async function generateSmartAIResponse(userMessage, conversationHistory, context, assessmentData, pool) {
  ...
  if (messageLower.includes('thank') || messageLower.includes('thanks')) {
    return "You're welcome! 😊 I'm here anytime you need help. Feel free to ask about anything on this page or the assessment in general!";
  }
  
  if (messageLower.includes('bye') || messageLower.includes('goodbye')) {
    return "Goodbye! 👋 I'll be here whenever you need assistance. Good luck with your assessment!";
  }
